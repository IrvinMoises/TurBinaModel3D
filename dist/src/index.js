...
/**/
/**/
function rotateTurbine(obj, af, totalIterations) {
    // Calcular el centro del objeto
    var center = TurboCenter(obj);
...
function TurboCenter(obj) {
    ...
    var numVertices = 4285; // Número total de vértices del objeto
...
document.getElementById('pza1Izq').addEventListener('click', function () { rotateTurbine(obj, -20, 6000); }, false);
